...
import (
	"flag"
	"fmt"
	"github.com/hj5657/instrument_trace/instrumenter"
	"github.com/hj5657/instrument_trace/instrumenter/ast"
	"io/ioutil"
	"os"
	"path/filepath"
)
...
func main() {
	...
	ins = ast.New("github.com/hj5657/instrument_trace", "trace", "Trace")
